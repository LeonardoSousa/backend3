...
class Retorno
{
    ...
    private $lineTrailerLote;
    private $lineTrailerArquivo;
    ...
    public static function moneyToMysql($valor): string {
        return (float)preg_replace("/(.*)(\d{2})$/", "$1.$2", $valor);
    }

    public static function dateToMysql($valor): string {
        if($valor === '00000000')
            return null;
    ...
    public function getHeaderArquivo(): HeaderArquivo
    {
        $arquivo = new HeaderArquivo();
    ...
    /**
     * @return array<\App\Libraries\Retorno\SegmentoT>
     */
    public function getSegmentosT():array
    {
        $segmentos = [];
    ...
    /**
     * @return array<\App\Libraries\Retorno\SegmentoU>
     */
    public function getSegmentosU():array
    {
        $segmentos = [];
    ...
    /**
     * @return array<\App\Libraries\Retorno\SegmentoY>
     */
    public function getSegmentosY():array
    {
        $segmentos = [];

        foreach ($this->linesY as $line) {
            $segmento = new SegmentoY();
    ...
    private function getValue($line, $start, $end, $type = "A"):string
    {
